...
**Preserve existing authored files** in `.knowledge/`, the constitution, `.gitignore`, and platform guide files (`ANTIGRAVITY.md`, etc.). Only create missing knowledge scaffolding, regenerate generated ontology files, or assimilate `.documentation/` content after review.
...
Read `.knowledge/governance/constitution.md` before making changes — it defines the project's non-negotiable principles.
```
