...
- Python 3.11+, Bash, PowerShell, Markdown, YAML, JSON Schema + Existing `jsonschema>=4.0`, `PyYAML>=6.0`, pytest (001-okf-genuine-fix)
...
Python 3.11+, Bash, PowerShell, Markdown, YAML, JSON Schema: Follow standard conventions

## Recent Changes

- 001-okf-genuine-fix: Added Python 3.11+, Bash, PowerShell, Markdown, YAML, JSON Schema + Existing `jsonschema>=4.0`, `PyYAML>=6.0`, pytest
