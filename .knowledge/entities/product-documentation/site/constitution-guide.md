...
The constitution lives at `/.knowledge/governance/constitution.md` in your project root.
...
4. Generate a draft constitution at `/.devspark.work/governance/constitution-draft.md`
...
| **Current Decision Files** | Technical choices with current context | "PostgreSQL is the persistence store", "Repositories isolate persistence concerns" |
...
# Current decision (goes in .knowledge/governance/decisions/)
## Input Validation Library
Zod is the input validation library because it integrates with TypeScript...

# Coding Standards (convention - goes in .knowledge/entities/product-documentation/site/standards.md)
## Validation Patterns  
...
- **Repository constitution** (`/.knowledge/governance/constitution.md`) — applies to all applications
- **App-local constitution** (`{app-path}/.knowledge/governance/constitution.md`) — adds app-specific rules
...
```markdown
# apps/payment-api/.knowledge/governance/constitution.md
...
| File | Agent | Purpose |
|------|-------|---------|
| `/.knowledge/governance/constitution.md` | All (via DevSpark) | Project principles, quality standards, governance |
...
```text
┌─────────────────────────────────────────┐
│         /.knowledge/governance/constitution.md          │  ← Principles (WHAT must be true)
...
│  .knowledge/entities/product-documentation/site/standards.md, .editorconfig │
└─────────────────────────────────────────┘
```
...
always consult `/.knowledge/governance/constitution.md` for non-negotiable principles.
...
**`/.knowledge/governance/constitution.md`** (principles):
...
Follow principles in `/.knowledge/governance/constitution.md` Section II.
...
1. **Shared principles**: All reference `/.knowledge/governance/constitution.md`
2. **Agent-specific behaviors**: Each file can have unique content
3. **Consider a shared include**: Some teams create `.knowledge/entities/product-documentation/site/ai-context.md` that all agent files reference
...
See `/.knowledge/governance/constitution.md` for project principles.
...
1. **Project Constitution**: `/.knowledge/governance/constitution.md`
   - Contains non-negotiable principles
   - Violations are blocking issues in PR review
   
2. **Coding Standards**: `.knowledge/entities/product-documentation/site/standards.md` (if exists)
   - Implementation patterns and conventions

3. **Architecture Decisions**: `.knowledge/governance/decisions/` (if exists)
...
Commands require `/.knowledge/governance/constitution.md` to exist:
