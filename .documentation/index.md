...
The v4.0.0 release ships 29 stock command prompts: 28 active commands plus one
...
| `/devspark.release` | Prepare release docs and version updates |
| `/devspark.harvest` | Preserve useful knowledge and clean stale artifacts |
...
`/devspark.archive` remains only as a deprecated compatibility alias. Use
`/devspark.harvest` for ongoing cleanup.

### Multi-App

| Command | Purpose |
|---------|---------|
| `/devspark.add-application` | Register an application in `.documentation/devspark.json` |
...
- `.documentation/` contains repository-owned documentation and guides.
