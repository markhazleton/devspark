...
provides 29 stock command prompts (28 active commands plus one deprecated
compatibility alias) plus helper templates and scripts that give any AI agent a
repeatable current-truth workflow.
...
- **Current-truth powered.** Projects keep durable code, `.knowledge`, and governance aligned while deleting completed planning scaffolding.
